				...
				projects: [
					{
						...
						media: exigoMedia,
						experiences: [{ person: 'adam', slug: 'adam-exigo', tagIds: ['systems-design', 'level-design'] }],
					},
					{
						...
						experiences: [{ person: 'adam', slug: 'adam-warhammer-mark-of-chaos', tagIds: ['systems-design', 'level-design'] }],
					},
				],
			},
		],
				...
				projects: [
					{
						...
						media: hyphaMedia,
						experiences: [{ person: 'adam', slug: 'adam-personal-project', tagIds: ['board-game'] }],
					},
					{
						id: 'biobot',
						name: 'Biobot',
						...
						dateRange: '2026',
						media: biobotMedia,
						experiences: [{ person: 'adam', slug: 'adam-biobot', tagIds: ['board-game'] }],
					},
				],
			},
		],
